...
public class TopKFrequentWords {
	...
	public List<String> topKFrequent(String[] words, int k) {
		...
		Comparator<Entry<String, Integer>> sorting = new Comparator<Entry<String, Integer>>() {
		...
		// Either this way
		Queue<Entry<String, Integer>> topQueue = new PriorityQueue<Entry<String, Integer>>(sorting);
		// or this way
		/*
